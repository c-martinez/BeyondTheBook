...
def __getCountrySeeds__(lang='en'):
    ...
    countrySeeds = {}
    if lang=='en':
        countrySeeds["US"] = [ "Wikipedians in U.S.A.", "Wikipedians in United States", "Wikipedians in United States Of America", "Wikipedians in United States of America", "Wikipedians in US", "Wikipedians in USA", "Wikipedians in the United States", "Wikipedians in the United States of America" ]
        countrySeeds["UK"] = [ "Wikipedians in UK", "Wikipedians in United Kingdom", "Wikipedians in the United Kingdom", "Wikipedians in the UK" ]
        countrySeeds["IN"] = [ "Wikipedians in India", "Wikipedians in the India", "Wikipedians in the Republic of INDIA" ]
        countrySeeds["CA"] = [ "Wikipedians in Canada" ]
        countrySeeds["AU"] = [ "Wikipedians in the Australia", "Wikipedians in AUSTRALIA", "Wikipedians in Australia" ]
        countrySeeds["PH"] = [ "Wikipedians in the Philippines", "Wikipedians in Philippines" ]
        countrySeeds["DE"] = [ "Wikipedians in Germany" ]
        countrySeeds["BR"] = [ "Wikipedians in Brazil" ]
        countrySeeds["IT"] = [ "Wikipedians in Italy" ]
        countrySeeds["IE"] = [ "Wikipedians in Ireland", "Wikipedians in the Republic of Ireland" ]
        countrySeeds["PK"] = [ "Wikipedians in Pakistan", "Wikipedians in the Pakistan" ]
        countrySeeds["FR"] = [ "Wikipedians in France" ]
        countrySeeds["MY"] = [ "Wikipedians in Malaysia" ]
        countrySeeds["NL"] = [ "Wikipedians in Netherlands", "Wikipedians in the Netherlands" ]
        countrySeeds["ID"] = [ "Wikipedians in Indonesia" ]
        countrySeeds["CN"] = [ "Wikipedians in China", "Wikipedians in Mainland China", "Wikipedians in the People's Republic of China", "Wikipedians in the People's Republic of China/", "Wikipedians in the Republic of China" ]
        countrySeeds["NZ"] = [ "Wikipedians in New Zealand" ]
        countrySeeds["ES"] = [ "Wikipedians in Spain", "Wikipedians in in Spain" ]
        countrySeeds["IR"] = [ "Wikipedians in the Iran", "Wikipedians in Iran" ]
        countrySeeds["MX"] = [ "Wikipedians in Mexico" ]
        countrySeeds["SE"] = [ "Wikipedians in Sweden" ]
        countrySeeds["RU"] = [ "Wikipedians in Russia" ]
        countrySeeds["GR"] = [ "Wikipedians in Greece" ]
        countrySeeds["TR"] = [ "Wikipedians in Turkey" ]
    elif lang=='nl':
